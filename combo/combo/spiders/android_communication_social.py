...
class AndroidCommunicationSocialSpider(scrapy.Spider):
    name = 'android_communication_social'
    page_number =2
    start_urls = ['https://en.uptodown.com/android/social/']
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/android/social/"+str(AndroidCommunicationSocialSpider.page_number)+"/"
        
        if next_page is not None:
            
            AndroidCommunicationSocialSpider.page_number +=1
            sleep(3)
