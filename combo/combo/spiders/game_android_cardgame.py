...
class CardSpider(scrapy.Spider):
    name = 'game-card'
    page_number =2
    start_urls = ['https://en.uptodown.com/android/card-games']
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/android/card-games/"+str(CardSpider.page_number)+"/"
        
        if next_page is not None:
            
            CardSpider.page_number +=1
            sleep(7)
