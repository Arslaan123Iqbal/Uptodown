...
class WindowsaudioAudistreamingSpider(scrapy.Spider):
    name = 'windowsaudio_audistreaming'
    page_number =2
    start_urls = ['https://en.uptodown.com/windows/audio-streaming/']
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/windows/audio-streaming/"+str(WindowsaudioAudistreamingSpider.page_number)+"/"
        
        if next_page is not None:
            
            WindowsaudioAudistreamingSpider.page_number +=1
            sleep(3)
    ...
    def parseInnerPage(self,response):
       ...
       # table data
        ...
        request= scrapy.Request(url=download_link,callback=self.download_page,meta={'dont_redirect': True})
