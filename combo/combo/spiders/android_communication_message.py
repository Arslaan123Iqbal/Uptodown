...
class MessageSpider(scrapy.Spider):
    name = 'android_communication_message'
    page_number =2

    start_urls = ['https://en.uptodown.com/android/communication-utilities']
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/android/communication-utilities"+str(MessageSpider.page_number)+"/"
        
        if next_page is not None:
            
            MessageSpider.page_number +=1
            sleep(3)
    ...
    def parseInnerPage(self,response):
       ...
       # table data
        ...
        for tr in table.css('tr'):
            ...
            result[replace_with_content] = replace_value
