...
class AndroidCommunicationUtilitiesSpider(scrapy.Spider):
    name = 'android_communication_utility'
    page_number =2
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/android/communication-utilities/"+str(AndroidCommunicationUtilitiesSpider.page_number)+"/"
        
        if next_page is not None:
            
            AndroidCommunicationUtilitiesSpider.page_number +=1
            sleep(7)
