...
class ActionSpider(scrapy.Spider):
    name = 'game-action-adventure'
    page_number =2
    start_urls = ['https://en.uptodown.com/android/action-adventure']
    ...
    def parse(self, response):
        ...
        next_page = "https://en.uptodown.com/android/action-adventure/"+str(ActionSpider.page_number)+"/"
        
        if next_page is not None:
            
            ActionSpider.page_number +=1
            sleep(7)
